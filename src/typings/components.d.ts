...
declare global {
  ...
  const ApprovalInfoPanel: typeof import('./../components/workflow/approval-info-panel.vue')['default']
  const BackTaskModal: typeof import('./../components/workflow/back-task-modal.vue')['default']
  ...
  const FlowCategorySelect: typeof import('./../components/workflow/flow-category-select.vue')['default']
  const FlowDrawer: typeof import('./../components/workflow/flow-drawer.vue')['default']
  const FlowInterveneModal: typeof import('./../components/workflow/flow-intervene-modal.vue')['default']
  const FlowPreview: typeof import('./../components/workflow/flow-preview.vue')['default']
  const FlowTaskApprovalModal: typeof import('./../components/workflow/flow-task-approval-modal.vue')['default']
  const FlowUrgeModal: typeof import('./../components/workflow/flow-urge-modal.vue')['default']
  ...
  const LeaveEdit: typeof import('./../components/workflow/form/leave-edit/index.vue')['default']
  ...
  const ReduceSignatureModal: typeof import('./../components/workflow/reduce-signature-modal.vue')['default']
  ...
  const TagGroup: typeof import('./../components/custom/tag-group.vue')['default']
  ...
  const UserSelectModal: typeof import('./../components/custom/user-select-modal.vue')['default']
