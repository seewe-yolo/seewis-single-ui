...
const searchParams = ref<Api.Workflow.InstanceSearchParams>({
  pageNum: 1,
  pageSize: 10,
  category: null,
  flowName: null,
...
const { columns, columnChecks, data, getData, getDataByPage, loading, mobilePagination, scrollX, reloadColumns } =
  useNaivePaginatedTable({
    api: () => {
      return runningStatus.value
        ? fetchGetRunningInstanceList(searchParams.value)
        : fetchGetFinishedInstanceList(searchParams.value);
    },
