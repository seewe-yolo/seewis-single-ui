...
const searchParams = ref<Api.Workflow.LeaveSearchParams>({
  pageNum: 1,
  pageSize: 10,
  startLeaveDays: null,
  endLeaveDays: null,
...
const { columns, columnChecks, data, getData, getDataByPage, loading, mobilePagination, scrollX } =
  useNaivePaginatedTable({
    api: () => fetchGetLeaveList(searchParams.value),
...
const { drawerVisible, editingData, checkedRowKeys, onBatchDeleted, onDeleted, openDrawer } = useTableOperate(
  data,
  'id',
  getData
);
...
<template>
  <div class="min-h-500px flex-col-stretch gap-16px overflow-hidden lt-sm:overflow-auto">
    <LeaveSearch v-model:model="searchParams" @search="getDataByPage" />
