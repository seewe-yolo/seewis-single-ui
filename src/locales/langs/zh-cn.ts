const local: App.I18n.Schema = {
  ...
  route: {
    ...
    workflow_spel: '流程表达式',
    workflow_task: '任务管理',
    'workflow_task_all-task-waiting': '全部待办',
  ...
  page: {
    ...
    dashboard: {
      ...
      emptyTodo: '暂无待办任务',
      emptyNotice: '暂无通知公告',
      todoUnavailable: '待办服务暂不可用',
      todoUnavailableDesc: '工作流模块未启用或当前用户没有访问权限。',
      partialLoad: '部分数据加载失败',
      partialLoadDesc: '请检查权限或稍后重试。',
      analysisTitle: '数据分析',
      analysisDesc: '基于系统用户、公告和操作日志的真实数据统计。',
      dateRange: '统计范围',
      last7Days: '最近 7 天',
      last30Days: '最近 30 天',
      trendTitle: '系统数据趋势',
      ...
      detailTitle: '趋势明细',
      loadFailed: '数据加载失败',
      loadFailedDesc: '请检查仪表盘权限或后端服务状态。',
      notice: '通知',
      announcement: '公告'
    },
    common: {
