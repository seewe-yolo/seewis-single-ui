const local: App.I18n.Schema = {
  ...
  route: {
    ...
    dashboard_analysis: 'Data Analysis',
  ...
  page: {
    ...
    dashboard: {
      greeting: 'Good morning, {userName}. Let’s make today productive!',
      todoCount: 'My Tasks',
      userCount: 'Users',
      deptCount: 'Departments',
      noticeCount: 'Notices',
      operationCount: 'Operation Logs',
      todoTitle: 'My Tasks',
      noticeTitle: 'Notices',
      viewAll: 'View All',
      viewAnalysis: 'Data Analysis',
      viewNotice: 'Notice Management',
      refresh: 'Refresh Data',
      emptyTodo: 'No pending tasks',
      emptyNotice: 'No notices',
      todoUnavailable: 'Task service unavailable',
      todoUnavailableDesc: 'The workflow module is disabled or you do not have access.',
      partialLoad: 'Some data failed to load',
      partialLoadDesc: 'Check permissions or try again later.',
      analysisTitle: 'Data Analysis',
      analysisDesc: 'Real statistics from users, notices, and operation logs.',
      dateRange: 'Date Range',
      last7Days: 'Last 7 days',
      last30Days: 'Last 30 days',
      trendTitle: 'System Trends',
      userStatus: 'User Status',
      normal: 'Normal',
      disabled: 'Disabled',
      date: 'Date',
      detailTitle: 'Trend Details',
      loadFailed: 'Failed to load data',
      loadFailedDesc: 'Check dashboard permissions or backend service status.',
      notice: 'Notice',
      announcement: 'Announcement'
    },
    common: {
